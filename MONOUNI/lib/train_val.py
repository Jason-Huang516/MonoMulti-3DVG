...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--evaluate', dest='evaluate',action='store_true',default=True,help='evaluate model on validation set')
    parser.add_argument('--config', type=str, default = r'F:\MonoUNI-main\lib\config.yaml')
